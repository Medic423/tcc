/*
  ...
  - You are about to drop the `backhaul_opportunities` table. If the table is not empty, all the data it contains will be lost.
  ...
  - You are about to drop the `unit_analytics` table. If the table is not empty, all the data it contains will be lost.
...
-- DropTable
DROP TABLE "backhaul_opportunities";
